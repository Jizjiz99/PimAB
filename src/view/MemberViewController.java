...
public class MemberViewController implements Initializable {
	...
	@FXML
	private TextArea taExecute;
	@FXML
	private TextField tfExecute;
	...
	@FXML
	private TableColumn<Member, String> columnPW;
	@FXML
	private TableColumn<Member, String> columnMobilePhone;
	...
	private void handleExecute() { // event source, listener, handler
		...
		/*
		 * str = taExecute.getText(); String name = tfExecute.getText(); str = str +
		 * ts.appendTextArea(name);
		 */
	...
	private void handleCreate() { // event source, listener, handler
		...
		taExecute.setText(str + "Hello JavaFX!\n");
	}
